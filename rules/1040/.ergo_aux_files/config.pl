...
#mode save
#mode nocomment "%"
#define FLORA_THIS_FILENAME  'config.ergo'
#mode restore
/************************************************************************
...
#mode save
#mode nocomment "%"
#define FLORA_FDB_FILENAME  'config.fdb'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLD_FILENAME  'config.fld'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLS_FILENAME  'config.fls'
#mode restore
...
#mode save
#mode nocomment "%"
#define FLORA_FLS2_FILENAME  'config.fls2'
#mode restore
...
?-(:(flrutils,util_load_structdb('config.ergo',FLORA_THIS_MODULE_NAME))).
